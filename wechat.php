...
class wechatCallbackapiTest {
    ...
    public function responseMsg() {
        ...
        if (!empty($postStr)) {
            ...
            $time         = time();
            $from_Content = trim($postObj->Content);
            ...
            switch ($from_MsgType) {
                ...
                case "event":
                    ...
                    switch ($event) {
                        case "subscribe":
                            if (substr($eventKey, 0, 8) == "qrsecne") {
            ...
            if (!empty($from_Content)) {
                switch ($from_Content) {
                    ...
                    //                        $subKeyword = mb_substr($from_Content, 0, 2, 'utf8');
                    //                        if ($subKeyword == "空气" || $subKeyword == "kq") {
                    //                            include("pm25.php");
                    //                            $city = mb_substr($from_Content, 2, 5, 'utf8');
                    ...
                    //                        }
                    case "?":
                        $textArray = ["这是我的个人微信公众号，最近正在开发后台，会慢慢添加一些有趣的功能哦!" .
